...
namespace Engine.Utility
{
    ...
    public static class ExpressHandler
    {
        ...
        /// <returns></returns>
        public static bool AtomicEffectPickCondition(ActionStatus game, string PosInfo, Effect.EffectDefine singleEffect)
        {
            ...
            switch (效果条件)
            {
                ...
                case "ISFREEZE":
                    if (YouOrMe == CardUtility.strMe)
                    {
                        ...
                        {
                            return game.AllRole.MyPublicInfo.BattleField.BattleMinions[int.Parse(Position) - 1].冰冻状态 != CardUtility.效果回合枚举.无效果;
                        }
                    }
                    else
                    {
                        ...
                        {
                            return game.AllRole.YourPublicInfo.BattleField.BattleMinions[int.Parse(Position) - 1].冰冻状态 != CardUtility.效果回合枚举.无效果;
                        }
                    }
                default:
                    break;
        ...
        /// <returns></returns>
        public static bool AbilityPickCondition(ActionStatus game, string 效果选择条件)
        {
        ...
        /// <returns></returns>
        internal static bool AppendAbilityCondition(ActionStatus game, Card.SpellCard.AbilityDefine Ability)
        {
